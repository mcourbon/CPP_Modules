...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/12 16:45:15 by shifterpro        #+#    #+#             */
/*   Updated: 2025/01/12 18:22:07 by shifterpro       ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void BitcoinExchange::printCSV() {
    ...
    cout << "For DATE 2022-02-06, price = " << this->_csv["2022-02-06"] << endl;
}
...
void chooseError(int status, string line) {
    ...
    iss >> delimiter >> ws >> delimiter >> ws >> valuePart;
    switch(status) {
        case INPUT_ERROR :
